...
const ADMIN_NAV = [
  ...
  { label: 'Retailers', href: '/admin-dashboard/retailers', icon: 'M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z' },
...
const VENDOR_NAV = [
  ...
  { label: 'Disputes', href: '/vendor-dashboard/disputes', icon: 'M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-2.5L13.732 4c-.77-.833-1.964-.833-2.732 0L4.082 16.5c-.77.833.192 2.5 1.732 2.5z' },
...
export default function MobileDrawer({ open, onClose, role }) {
  ...
  const isActive = (href) => {
    if (href === '/vendor-dashboard' || href === '/admin-dashboard' || href === '/retailer-dashboard' || href === '/account') {
