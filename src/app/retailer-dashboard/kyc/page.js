...
const NIGERIAN_BANKS = [
  ...
  'Abir Microfinance Bank', 'ALAT by Wema', 'Amju Unique Microfinance Bank',
  'ASO Savings and Loans', 'Baobab Microfinance Bank', 'Branch International Finance',
  'Carbon (Formerly OneCredit)', 'Chaka', 'Cowrywise',
  'CrusaderSterling Microfinance Bank', 'Ekondo Microfinance Bank', 'Eyowo',
  'Fairmoney', 'Firmus Finance', 'FSDH Asset Managers',
  'Jubilee Life Mortgage Bank', 'Lagos Building Investment Company',
  'Lotus Bank', 'Meridian Microfinance Bank', 'Money Trust Microfinance Bank',
  'NPF Microfinance Bank', 'Oakland Microfinance Bank', 'One Finance',
  'Parallex Bank', 'Petra Microfinance Bank', 'Rephidim Microfinance Bank',
  ...
  'Unical Microfinance Bank', 'Wow Momo', 'Zedvance',
];
